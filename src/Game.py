...
class Game:
    ...
    def ask_player_to_add_card(self, ask = None): # 根據input判斷是否要抽 return bool
        print("Do you want to add card? (y/n)")
        ask = input()
        if ask == 'y':
            return True
        else:
    ...
    def owner_add_card_phase(self): # 玩家開牌 判斷玩家爆牌沒 莊家開牌 莊家抽不抽 結果判斷
        ...
        if self.player_point > 21:
            self.game_result = self.player_name + "  loses, you are over 21"
        ...
        if self.player_point == 21:
            self.game_result = self.player_name + "  wins, you are 21"
            print("this round is over")
            print("owner's dark card is " + self.owner_cards[0])
            print(self.player_name + "'s card are " + str(self.player_cards))
            print("owner's card are " + str(self.owner_cards))
        ...
        if self.owner_point > 21:
            self.game_result = self.player_name + "  wins, owner is over 21"
            print("this round is over")
            print("owner's dark card is " + self.owner_cards[0])
            print(self.player_name + "'s card are " + str(self.player_cards))
            print("owner's card are " + str(self.owner_cards))
        ...
        if self.owner_point == 21:
            self.game_result = self.player_name + "  loses, owner is 21"
            print("this round is over")
            print("owner's dark card is " + self.owner_cards[0])
            print(self.player_name + "'s card are " + str(self.player_cards))
            print("owner's card are " + str(self.owner_cards))            
        ...
        if self.owner_point > self.player_point:
            self.game_result = self.player_name + "  loses, player's point is " + str(self.player_point) + ", owner's point is " + str(self.owner_point)
            print("this round is over")
            print("owner's dark card is " + self.owner_cards[0])
            print(self.player_name + "'s card are " + str(self.player_cards))
            print("owner's card are " + str(self.owner_cards))
        ...
        if self.owner_point < self.player_point:
            self.game_result = self.player_name + "  wins, player's point is " + str(self.player_point) + ", owner's point is " + str(self.owner_point)
            print("this round is over")
            print("owner's dark card is " + self.owner_cards[0])
            print(self.player_name + "'s card are " + str(self.player_cards))
            print("owner's card are " + str(self.owner_cards))
        ...
        if self.owner_point == self.player_point:
            self.game_result = self.player_name + " draws, player's point is " + str(self.player_point) + ", owner's point is " + str(self.owner_point)
            print("this round is over")
            print("owner's dark card is " + self.owner_cards[0])
            print(self.player_name + "'s card are " + str(self.player_cards))
            print("owner's card are " + str(self.owner_cards))
